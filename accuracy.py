...
def get_advloader(dataset_type,attack_type):
    ...
    label_path='./AdversarialExampleDatasets/'+attack_type+'/'+dataset_type+'/'+attack_type+'_AdvLabels.npy'
...
accuracy = testing_evaluation(model=final_model, test_loader=adv_loader, device=device)
